...
class FrameBuffer:
    def __init__(self, width, height, **kwargs):
        ...
        self._renderbuffer = kwargs.get(
            'renderbuffer') or glGenRenderbuffers(1)
    ...
    def _compile(self):
        ...
        glFramebufferRenderbuffer(
            GL_FRAMEBUFFER, GL_DEPTH_STENCIL_ATTACHMENT, GL_RENDERBUFFER, self._renderbuffer)
    ...
    def saveTextureToFile(self, filepath:str, format="PNG"):
        self.attach()
        imgdata = glReadPixels(0, 0, self.window_width, self.window_height, GL_RGBA, GL_UNSIGNED_BYTE)
